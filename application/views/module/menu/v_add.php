                  ...
                  <li><a class="text-primary" href="<?= site_url('pasien/tambah');?>"><i class="fa fa-arrow-left"></i> Kembali</a>
								...
								<div class="x_content">
									<br />
<?= validation_errors()?>
<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?= site_url('menu');?>" method="post">
                          ...
                          <?php endforeach; ?>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="tags_1" type="text" class="tags form-control" value="" name="nama_menu" />
                      ...
                      <div class="col-md-6 col-sm-6">
												<input id="berat" type="text" class="tags form-control" value="" name="berat" style="width: 100%;"/>
												<div id="suggestions-container" style="position: relative; float: left; width: 250px; margin: 10px;"></div>
                      </div>
										</div>
